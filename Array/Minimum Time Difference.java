...
class Solution {
    ...
    private int getDifference(String timePoint1, String timePoint2) {
        int time1 = Integer.parseInt(timePoint1.split(":")[0]) * 60 + Integer.parseInt(timePoint1.split(":")[1]);
        int time2 = Integer.parseInt(timePoint2.split(":")[0]) * 60 + Integer.parseInt(timePoint2.split(":")[1]);
        return Math.min(time2 - time1, time1 - time2 + 24 * 60);
    }
}
